        ...
        <div class="menu">
            <table class="menu-container" border="0">
               ...
               <tr class="menu-row" >
                ...
                <tr class="menu-btn menu-icon-doctor">
                    <td>
                        <a href="doctors.php" class="non-style-link-menu "><div><p class="menu-text">Doctors</p></a></div>
                    </td>
                </tr>
                <tr class="menu-btn menu-icon-patient">
                    <td>
...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from doctor where docemail='$keyword' or docname='$keyword' or docname like '$keyword%' or docname like '%$keyword' or docname like '%$keyword%' or doccity='$keyword' or doccity='$keyword' or doccity like '$keyword%' or doccity like '%$keyword' or doccity like '%$keyword%'";
                    }else{
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="doccity" class="input-text" placeholder="City" required><br>
                                </td>
                            </tr>
